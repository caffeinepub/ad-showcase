...
export class Backend implements backendInterface {
    ...
    async createAd(arg0: string, arg1: string, arg2: string, arg3: ExternalBlob | null, arg4: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createAd(arg0, arg1, arg2, await to_candid_opt_n10(this._uploadFile, this._downloadFile, arg3), arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deactivateAd(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deactivateAd(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAd(arg0: string): Promise<Ad> {
        if (this.processError) {
            try {
                const result = await this.actor.getAd(arg0);
                return from_candid_Ad_n12(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
...
async function from_candid_vec_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Ad>): Promise<Array<Ad>> {
